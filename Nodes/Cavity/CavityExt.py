...
class CavityExt:
	"""
	CavityExt is an extension for the Cavity node.
	...
	def OnPulse(self, name):
		if name == 'Help':
			# open html browser
			mod.webbrowser.open('https://github.com/CraftKontrol/GroundGen-for-Touchdesigner/wiki/cavity')
		pass
